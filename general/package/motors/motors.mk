...
define MOTORS_BUILD_CMDS
	...
	if [ -d $(@D)/an41908 ]; then \
		cd $(@D)/an41908; \
		if [ -f main.c ]; then $(TARGET_CC) -Os -s main.c -o an41908; \
		elif [ -f an41908.c ]; then $(TARGET_CC) -Os -s an41908.c -o an41908; \
		elif [ -f an41908a.c ]; then $(TARGET_CC) -Os -s an41908a.c -o an41908; \
		fi; \
